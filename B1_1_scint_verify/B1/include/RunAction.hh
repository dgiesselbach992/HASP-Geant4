...
class RunAction : public G4UserRunAction
{
  public:
	...
	void EnterCount(const std::string& name, G4int parentID);
	void ScintCount(const std::string& name, G4int parentID);
	void ExitCount(const std::string& name, G4int parentID);
  ...
  private:
	...
	std::map<std::string, int> fEnterCounts;   // particles entering the 2nd scintillator
	std::map<std::string, int> fExitCounts;    // particles exiting the 2nd scintillator
	std::map<std::string, int> fScintCounts;   // scintillated in 2nd scintillator
