...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
 ...
 // Extract composition
  ...
  // Envelope parameters
  //
  G4double env_sizeXY = 20 * cm, env_sizeZ = 27.5 * cm;
  ...
  G4ThreeVector pos1 = G4ThreeVector(0, 0, -12.5 * cm);
  ...
  G4ThreeVector pos2 = G4ThreeVector(0, 0, -10.5 * cm);
  ...
  G4ThreeVector pos4 = G4ThreeVector(0, 0, -8.25 * cm);
  ...
  G4ThreeVector pos5 = G4ThreeVector(0, 0, 11.5 * cm);
  ...
  G4ThreeVector pos6 = G4ThreeVector(0, 0, 12 * cm);
  ...
  G4ThreeVector pos7 = G4ThreeVector(0, 0, 12.75 * cm);
...
void DetectorConstruction::ConstructSDandField()
{
    ...
    // ------------------------------------------------------------
    auto sipmSD2 = new B1::SiPMSD("SiPMSD2", 0);
    sdManager->AddNewDetector(sipmSD1);
    ...
    // ------------------------------------------------------------
    auto vacuumSD2 = new B1::VacuumSD("VacuumSD2", 0);
    sdManager->AddNewDetector(vacuumSD1);
