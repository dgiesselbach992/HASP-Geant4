...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  // Envelope parameters
  //
  G4double env_sizeXY = 20 * cm, env_sizeZ = 34.5 * cm;
  ...
  G4ThreeVector pos1 = G4ThreeVector(0, 0, -6.87 * cm);

  // Rectangluar shape
  G4double shape1_x = 3.81 * cm;
  G4double shape1_y = 3.81 * cm;
  G4double shape1_z = 15.24 * cm;
  auto solidShape1 =
  ...
  G4ThreeVector pos2 = G4ThreeVector(0, 0, -18.74 * cm);

  G4double shape2_x = 3.81 * cm;
  G4double shape2_y = 3.81 * cm;
  ...
  // Shape 3
  //            
  G4String shape3_name = "Scintillator 1";
  G4Material* shape3_mat = scint_mat;   // the scintillator material you defined earlier
  G4ThreeVector pos3 = G4ThreeVector(0, 0, -16.74 * cm);

  G4double shape3_x = 3.81 * cm;
  G4double shape3_y = 3.81 * cm;
  ...
  G4ThreeVector pos4 = G4ThreeVector(0, 0, -15.99 * cm);
  ...
  G4ThreeVector pos5 = G4ThreeVector(0, 0, 2.25 * cm);

  G4double shape5_x = 3.81 * cm;
  G4double shape5_y = 3.81 * cm;
  ...
  G4ThreeVector pos6 = G4ThreeVector(0, 0, 4.25 * cm);

  G4double shape6_x = 3.81 * cm;
  G4double shape6_y = 3.81 * cm;
  ...
  G4ThreeVector pos7 = G4ThreeVector(0, 0, 5 * cm);
  ...
  G4ThreeVector pos8 = G4ThreeVector(0, 0, 6.75 * cm);

  G4double shape8_x = 3.81 * cm;
  G4double shape8_y = 3.81 * cm;
  ...
  G4ThreeVector pos9 = G4ThreeVector(0, 0, 8.75 * cm);

  G4double shape9_x = 3.81 * cm;
  G4double shape9_y = 3.81 * cm;
  ...
  G4ThreeVector pos10 = G4ThreeVector(0, 0, 9.5 * cm);
  ...
  G4ThreeVector pos11 = G4ThreeVector(0, 0, 11.25 * cm);

  G4double shape11_x = 3.81 * cm;
  G4double shape11_y = 3.81 * cm;
  ...
  G4ThreeVector pos12 = G4ThreeVector(0, 0, 13.25 * cm);

  G4double shape12_x = 3.81 * cm;
  G4double shape12_y = 3.81 * cm;
  ...
  G4ThreeVector pos13 = G4ThreeVector(0, 0, 14 * cm);
...
void DetectorConstruction::ConstructSDandField()
{
    ...
    // ------------------------------------------------------------
    auto sipmSD3 = new B1::SiPMSD("SiPMSD3", 3);
    ...
    // ------------------------------------------------------------
    auto vacuumSD3 = new B1::VacuumSD("VacuumSD3", 3);
    sdManager->AddNewDetector(vacuumSD3);
    ...
    // ------------------------------------------------------------
    auto sipmSD4 = new B1::SiPMSD("SiPMSD4", 4);
    ...
    // ------------------------------------------------------------
    auto vacuumSD4 = new B1::VacuumSD("VacuumSD4", 4);
