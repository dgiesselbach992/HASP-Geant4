...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  // Envelope parameters
  //
  G4double env_sizeXY = 24 * cm, env_sizeZ = 23.5 * cm;
  ...
  G4ThreeVector pos1 = G4ThreeVector(4 * cm, 4 * cm, -2.25 * cm);

  // Rectangluar shape
  G4double shape1_x = 5 * cm;
  G4double shape1_y = 5 * cm;
  G4double shape1_z = 15 * cm;
  auto solidShape1 =
...
void DetectorConstruction::ConstructSDandField()
{
    ...
    // ------------------------------------------------------------
    // 7. Vacuum SD 4 (non-optical particle types)
    // ------------------------------------------------------------
    ...
    // ------------------------------------------------------------
    // 8. SiPM SD 4 (optical photons only)
    // ------------------------------------------------------------
