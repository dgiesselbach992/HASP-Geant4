...
count=$(ls results/results_*.csv 2>/dev/null | wc -l)
next=$((count + 1))
csvfile="results/results_${next}.csv"
...
{
    echo
    echo "Total,$sum1_proton,$sum1_electron,$sum1_gamma,$sum1_pion,$sum1_muon,$sum1_kaon,$sum1_other,$sum1_total,$sum1_photons,$sum2_proton,$sum2_electron,$sum2_gamma,$sum2_pion,$sum2_muon,$sum2_kaon,$sum2_other,$sum2_total,$sum2_photons"
    echo "Average,$avg1_proton,$avg1_electron,$avg1_gamma,$avg1_pion,$avg1_muon,$avg1_kaon,$avg1_other,$avg1_total,$avg1_photons,$avg2_proton,$avg2_electron,$avg2_gamma,$avg2_pion,$avg2_muon,$avg2_kaon,$avg2_other,$avg2_total,$avg2_photons"
    echo "PerPrimary,$norm1_proton,$norm1_electron,$norm1_gamma,$norm1_pion,$norm1_muon,$norm1_kaon,$norm1_other,$norm1_total,$norm1_photons,$norm2_proton,$norm2_electron,$norm2_gamma,$norm2_pion,$norm2_muon,$norm2_kaon,$norm2_other,$norm2_total,$norm2_photons"
} >> "$csvfile"
