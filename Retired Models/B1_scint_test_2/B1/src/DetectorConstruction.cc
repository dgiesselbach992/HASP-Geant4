...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  // Envelope parameters
  //
  G4double env_sizeXY = 20 * cm, env_sizeZ = 23 * cm;
  ...
  G4ThreeVector pos1 = G4ThreeVector(0, 0, -4.5 * cm);
  ...
  G4ThreeVector pos4 = G4ThreeVector(0, 0, 4.75 * cm);
  ...
  G4ThreeVector pos5 = G4ThreeVector(0, 0, 6.5 * cm);
  ...
  G4ThreeVector pos7 = G4ThreeVector(0, 0, 9.25 * cm);
